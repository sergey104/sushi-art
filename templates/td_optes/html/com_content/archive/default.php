...
<form id="adminForm" action="<?php echo JRoute::_('index.php')?>" method="post" class="form-inline">
	...
	<div class="filter-search stylefilter">
		<?php if ($this->params->get('filter_field') != 'hide') : ?>
		<label class="filter-search-lbl" for="filter-search"><?php echo JText::_('Search Archive Articles:').'&#160;'; ?></label>
...
<button type="submit" class="button small"><?php echo JText::_('JGLOBAL_FILTER_BUTTON'); ?></button>
	</div>
