...
<a href="<?php echo htmlspecialchars($facebook); ?>"><img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/facebook.png" width="32" height="32" alt="f" ></a>
